import { faListUl, faMobileAlt, faShoppingCart } from "@fortawesome/free-solid-svg-icons";
...
export const ProductIcon = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <FontAwesomeIcon
        ...
        width={width}
        height={height}
        viewBox="-150 100 700 40"
        icon={faMobileAlt}
    />
);

export const CarttIcon = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <FontAwesomeIcon
        className={className}
        width={width}
        height={height}
        viewBox="-80 100 700 40"
        icon={faShoppingCart}
    />
);

export const CategoryItem = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <FontAwesomeIcon
        className={className}
        width={width}
        height={height}
